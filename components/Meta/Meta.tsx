...
export default () => (
  <Head>
    ...
    <meta name="og:title" content={MOON_HOLDINGS}/>
    ...
    <meta name="og:site_name" content={MOON_HOLDINGS}/>
    <meta name="og:description" content="Your Cryptocurrency Portfolio"/>

    <meta name="twitter:title" content={MOON_HOLDINGS}/>
