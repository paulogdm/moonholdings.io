      ...
      <AboutContainer>
        ...
        <TeamImages>
          <TeamDiv>
            ...
            <p>Is a UI developer who comes from a design background, a self-taught coder with a passion for educating people about cryptocurrencies.</p>
          </TeamDiv>
          <TeamDiv>
            ...
            <p>A self-taught full-stack programmer with a passion for coding, math, teaching code and constant learning.</p>
          </TeamDiv>
        </TeamImages>
        <p>Our first product is <span>MOON.HOLDINGS</span>, a web UI based cryptocurrency portfolio tracker. And we have a roadmap to introduce user accounts and adding gamified ranking elements to growing your crypto wealth.</p>
        <NomicsLink/>
